...
var createNewTaskElement = function (taskString) {
  ...
  label.className = "todo-block__label input__label";
  ...
  editInput.type = "text";
  editInput.className = "todo-block__input input__label input-text input-edit ";
...
var editTask = function () {
  ...
  var containsClass = listItem.classList.contains("todo-block__edit");
  ...
  listItem.classList.toggle("todo-block__edit");
};
